...
import 'package:groceryPro/screens/drawer/edit-address.dart';
import 'package:groceryPro/screens/payment/payment.dart';
import 'package:groceryPro/service/cart-service.dart';
import 'package:groceryPro/service/common.dart';
import 'package:groceryPro/service/coupon-service.dart';
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                                                ...
                                                Container(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    decoration: InputDecoration(
                                                        hintText: "Enter coupon code"/*MyLocalizations
                                                                .of(context)
                                                            .getLocalizations(
                                                                "ENTER_COUPON_CODE")*/,
                                                        hintStyle:
                                                    ...
                                                    validator: (String value) {
                                                      if (value.isEmpty) {
                                                        return "Enter coupon code"/*MyLocalizations
                                                                .of(context)
                                                            .getLocalizations(
                                                                "ENTER_COUPON_CODE")*/;
                                                      } else {
                                                            ...
                                                            child: isCouponLoading
                                                                ...
                                                                : Text(
                                                                    /*MyLocalizations.of(context)
                                                                            .getLocalizations("APPLY")*/ "APPLY" +
                                                                        " ",
                                                                    style:
                                                                        textbarlowRegularWhite(),
                                                                  ),
                                                          ),
                                                          color: primary,
                                                        ),
                            ...
                            GFAccordion(
                              ...
                              titleChild: Text(/*MyLocalizations.of(context)
                            ...
                            Constants.predefined == "true"
                                ? Container(
                                    padding: EdgeInsets.only(
                                        left: 15, right: 15, bottom: 10),/*MyLocalizations.of(context)
                                              .getLocalizations(
                                                  "TIME_ZONE_MESSAGE")*/
                            ...
                            Container(
                              ...
                              child: Text("Choose date time",
                                style: textbarlowRegularadd(),/*MyLocalizations.of(context)
